...
const page: React.FC = () => {
  ...
  return (
    <section>
     ...
     <DashboardContainer>
     <div className="p-6 border rounded-md border-gray-700">
<div className='flex md:flex-row flex-col md:items-center md:justify-between'>
<div className="relative py-1 md:w-[25rem] border border-gray-600 rounded-md bg-inherit">
      ...
      <tbody>
        {employees.map((employee, index) => (
          <tr
            key={employee.id}
            className={`${
              index !== employees.length - 1 ? "border-b border-gray-700" : ""
            }`}
          >
            ...
            <td className="p-3 border-gray-600">{employee.employeeId}</td>
            <td className="p-3 border-gray-600">{employee.department}</td>
            <td className="p-3 border-gray-600">{employee.designation}</td>
            <td className="p-3 border-gray-600">{employee.type}</td>
